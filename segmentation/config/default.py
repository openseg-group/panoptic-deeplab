...
# Auxiliary loss
_C.LOSS.AUX_SEMANTIC = CN()
_C.LOSS.AUX_SEMANTIC.NAME = 'cross_entropy'
_C.LOSS.AUX_SEMANTIC.IGNORE = 255
_C.LOSS.AUX_SEMANTIC.REDUCTION = 'mean'
_C.LOSS.AUX_SEMANTIC.THRESHOLD = 0.7
_C.LOSS.AUX_SEMANTIC.MIN_KEPT = 100000
_C.LOSS.AUX_SEMANTIC.TOP_K_PERCENT = 1.0
_C.LOSS.AUX_SEMANTIC.WEIGHT = 0.4
